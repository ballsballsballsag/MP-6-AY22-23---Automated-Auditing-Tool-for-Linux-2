...
cmd=$(nft list ruleset | awk '/hook input/,/}/' | grep 'iif "lo" accept' | grep 2> \dev\null)
cmd1=$(nft list ruleset | awk '/hook input/,/}/' | grep 'ip saddr' | grep 2> \dev\null)
cmd2=$(nft list ruleset | awk '/hook input/,/}/' | grep 'ip6 saddr' | grep 2> \dev\null)
