...
cmd1=$(systemctl is-enabled aidecheck.service 2>/dev/null)
cmd2=$(systemctl is-enabled aidecheck.timer 2>/dev/null)
cmd3=$(systemctl status aidecheck.timer 2>/dev/null)
correct="enabled"
