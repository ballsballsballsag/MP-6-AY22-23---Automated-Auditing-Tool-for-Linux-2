...
cmd=$(nft list ruleset | awk '/hook input/,/}/' | grep 'iif "lo" accept' 2> \dev\null)
cmd1=$(nft list ruleset | awk '/hook input/,/}/' | grep 'ip saddr' 2> \dev\null)
cmd2=$(nft list ruleset | awk '/hook input/,/}/' | grep 'ip6 saddr' 2> \dev\null)
